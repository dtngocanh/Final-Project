...
import { Trash2, UserPlus, Eye, Search, Filter } from "lucide-react";
      ...
      <div className="relative z-10 p-6 max-w-7xl mx-auto">
        ...
        <div className="flex flex-wrap gap-4 mb-8">
          <div className="relative flex-1 min-w-[300px] group">
            <Search
              className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-300 group-focus-within:text-[#77cd3af2] transition-colors"
              size={18}
            />
            <input
              type="text"
          ...
          <table className="w-full text-left">
            <thead className="bg-[#f8faf9]/80 text-[10px] uppercase tracking-[0.2em] text-gray-400 border-b border-gray-50">
              <tr>
                ...
                <th className="px-6 py-7 text-center font-black">
                  Contribution
                </th>
            ...
            <tbody className="divide-y divide-gray-50 text-sm italic font-medium">
              {loading ? (
                <tr>
                  <td
                    colSpan="5"
                    className="text-center py-20 text-[#77cd3af2] animate-pulse font-bold"
                  >
                    LOADING USERS...
                  </td>
                </tr>
                ...
                filteredUsers.map((user) => (
                  <tr
                    key={user._id}
                    className="hover:bg-white/80 group transition-all duration-300"
                  >
                    <td className="px-10 py-8">
                      <div className="flex items-center gap-5">
                        ...
                        <div>
                          <p className="font-bold text-gray-800 text-base not-italic">
                            {user.name}
                          </p>
                    ...
                    <td className="px-6 py-8">
                      <div className="flex justify-center gap-3">
                        <button
                          ...
                          className="p-3.5 bg-gray-50 text-gray-400 rounded-2xl hover:bg-gray-800 hover:text-white transition-all shadow-sm"
                        >
                          <Eye size={18} />
                        </button>
                        <button
