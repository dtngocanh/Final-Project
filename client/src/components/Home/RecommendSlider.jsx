...
import { Plus, ArrowRight, ChevronLeft, ChevronRight, Star, Leaf } from "lucide-react";
import FloatingDecor from "../Fruit/FloatingDecor.jsx";
import { useCartActions } from "../../hooks/useCartActions";

const MOCK_PRODUCTS = [
  { _id: "1", name: "Baby Spinach", price: 4.5, ratings: 4.9, image: "/honey.png", tag: "Veganic Choice" },
  { _id: "2", name: "Organic Carrots", price: 3.2, ratings: 4.8, image: "/cheri2.png", tag: "Non-GMO" },
  { _id: "3", name: "Red Bell Pepper", price: 5.9, ratings: 5.0, image: "/apple.png", tag: "Premium Quality" },
  { _id: "4", name: "Fresh Broccoli", price: 4.0, ratings: 4.7, image: "/cabage.png", tag: "Veganic Choice" },
  { _id: "5", name: "Sweet Corn", price: 2.5, ratings: 4.9, image: "/lemon.png", tag: "Eco-Friendly" },
];
      ...
      <div className="max-w-[1400px] mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col items-center mb-14 text-center">
          ...
          >
            ...
            />
            <span className="text-[10px] font-light tracking-[0.8em] text-neutral-400">
              Veganic Recommend 
            </span>
          </motion.div>

          <div className="relative">
            <h3 className="text-3xl md:text-4xl font-extralight tracking-tighter text-gray-950 dark:text-white leading-none">
              {title} for you  
            </h3>
          </div>
        </div>
        ...
        <div className="relative group/slider">
          ...
          <div className="absolute top-1/2 -left-2 -translate-y-1/2 z-20 hidden md:block opacity-0 group-hover/slider:opacity-100 transition-opacity">
            <button onClick={() => scroll("left")} className="p-2 text-neutral-300 hover:text-[#77cd3a] transition-all">
          ...
          <div className="absolute top-1/2 -right-2 -translate-y-1/2 z-20 hidden md:block opacity-0 group-hover/slider:opacity-100 transition-opacity">
            <button onClick={() => scroll("right")} className="p-2 text-neutral-300 hover:text-[#77cd3a] transition-all">
                ...
                <div className="relative flex flex-col h-[380px]">
                  ...
                  <div className="relative flex-grow rounded-[2rem] bg-neutral-50 dark:bg-neutral-900/30 border border-neutral-100 dark:border-white/5 overflow-hidden transition-all duration-500 group-hover:bg-white dark:group-hover:bg-neutral-800 group-hover:shadow-xl group-hover:shadow-black/5">
                    ...
                    <div className="absolute top-4 left-4 z-10 flex items-center gap-1">
                      ...
                      <span className="text-[10px] font-bold text-neutral-400">{product.ratings}</span>
                    </div>

                    {/* Image Area - LOGIC GIỐNG PRODUCT SLIDER */}
                    <Link to={`/product/${product._id}`} className="absolute inset-0 flex items-center justify-center overflow-hidden">
                      <motion.div 
            ...
            <div className="min-w-[120px] flex items-center justify-center snap-start">
               <Link to="/products" className="group flex flex-col items-center gap-2">
                  <div className="w-10 h-10 rounded-full border border-dashed border-neutral-200 dark:border-neutral-800 flex items-center justify-center group-hover:border-[#77cd3a] transition-all">
                    <ArrowRight size={16} className="text-neutral-300 group-hover:text-[#77cd3a]" />
                  </div>
                  <span className="text-[7px] font-bold uppercase tracking-widest text-neutral-400">Show All</span>
               </Link>
            </div>
          </div>
        </div>
