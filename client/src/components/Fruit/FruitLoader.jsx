...
const FruitLoader = () => {
  const loadingText = "LOADING PRODUCT...".split("");
  const totalDuration = 3; // Thời gian cà chua chạy hết 1 vòng
  
  // Container chính theo ý bạn
  return (
    <div className="h-[400px] flex items-center justify-center bg-white/50 backdrop-blur-sm overflow-hidden">
