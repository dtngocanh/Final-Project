      ...
      */}
      ...
      <div className="relative z-10 flex items-center gap-2 md:gap-4">
        ...
        <button
          ...
          className="p-2.5 hover:scale-110 transition-transform"
        >
        ...
        <button
          ...
          className="relative p-2.5 hover:scale-110 transition-transform"
        >
          <Bell size={21} strokeWidth={2} style={{ color: activeColor }} />
        </button>
