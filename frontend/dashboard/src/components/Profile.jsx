        ...
        <div className="space-y-8">
          ...
          <div className="bg-white/70 dark:bg-[#0a0a0a]/70 backdrop-blur-xl rounded-[2.5rem] p-6 md:p-10 border border-white/20 dark:border-white/5 shadow-2xl shadow-black/5">
            <div className="flex items-center gap-3 mb-10">
              ...
              <h3 className="text-xs md:text-sm font-bold uppercase tracking-widest text-gray-400">
                Basic Information
              </h3>
            </div>
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-10 md:gap-16">
              ...
              <div className="flex flex-col items-center space-y-4">
                ...
                <div className="text-center">
                  <p className="text-[10px] text-[#77cd3af2] font-black uppercase tracking-widest">
                    Verified Seller
                  </p>
                </div>
              </div>
              ...
              <div className="flex-1 w-full space-y-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <label className="text-[9px] uppercase tracking-widest font-black text-gray-400 ml-1">
                      Full Name
                    </label>
            ...
            >
              <div className="space-y-8">
                <div className="group relative border-b border-gray-100 dark:border-white/5 pb-2">
                  <label className="text-[10px] text-gray-400 uppercase tracking-[0.2em] font-black">
                    Current Password
                  </label>
                  <input
                    type="password"
